...
bench( format( '%s:ndims=1,dims=[0]', pkg ), function benchmark( b ) {
	...
	for ( i = 0; i < b.iterations; i++ ) {
		v = reverseDimensions( values[ i%values.length ], [ 0 ] );
		if ( typeof v !== 'object' ) {
...
bench( format( '%s:ndims=2,dims=[0,1]', pkg ), function benchmark( b ) {
	...
	b.tic();
	for ( i = 0; i < b.iterations; i++ ) {
		v = reverseDimensions( values[ i%values.length ], [ 0, 1 ] );
		if ( typeof v !== 'object' ) {
			b.fail( 'should return an ndarray' );
		}
	}
...
bench( format( '%s:ndims=3,dims=[0,2]', pkg ), function benchmark( b ) {
	...
	b.tic();
	for ( i = 0; i < b.iterations; i++ ) {
		v = reverseDimensions( values[ i%values.length ], [ 0, 2 ] );
		if ( typeof v !== 'object' ) {
			b.fail( 'should return an ndarray' );
		}
	}
...
bench( format( '%s:ndims=3,dims=[0,1,2]', pkg ), function benchmark( b ) {
	...
	b.tic();
	for ( i = 0; i < b.iterations; i++ ) {
		v = reverseDimensions( values[ i%values.length ], [ 0, 1, 2 ] );
		if ( typeof v !== 'object' ) {
			b.fail( 'should return an ndarray' );
		}
	}
